...
foreach ($data as $pedido) {
    echo "<tr>
        ...
        <td style='color: black;'><a href='index.php?controller=OrderController&action=GetproductsByPedido&pedido_id=" . $pedido['ID_Pedido'] . "'>Detalles</a></td>
    ...
    if ($pedido['Estado'] == 'En proceso') {
        ...
        echo "<td><button type='submit' formaction='index.php?controller=OrderController&action=borrarPedido' class='btn btn-danger' name='borrarPedido' value='" . $pedido['ID_Pedido'] . "'>Borrar</button></td>";
    }
