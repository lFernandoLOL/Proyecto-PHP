...
REPLACE INTO `Productos` (`ID_Producto`, `Nombre_Prod`, `Descripcion`, `Precio`, `ID_Cat`) VALUES
	...
	(7, 'Triple Caparazón Verde', 'Tres caparazones verdes rodean al usuario que usa el objeto. Cuando el usuario vaya pulsando L1, los caparazones se lanzarán de uno en uno.', 300, 2),
	(8, 'Triple Caparazón Rojo', 'Tres caparazones rojos rodean al usuario que usa el objeto. Cuando el usuario vaya pulsando L1, los caparazones se lanzarán de uno en uno.', 600, 2),
	(14, 'Triple Plátano', 'Tres plátanos rodean al usuario que usa el objeto. Cuando el usuario vaya pulsando L1, los caparazones se lanzarán de uno en uno.', 150, 2),
	(23, 'Nintendo Switch', 'Nintendo Switch es una consola de videojuegos desarrollada por Nintendo. Conocida en el desarrollo por su nombre código «NX», se dio a conocer en octubre de 2016 y fue lanzada mundialmente el 3 de marzo de 2017.', 2500, 1),
	...
	(35, 'Peluche Sócrates AC', 'Peluche del personaje que lleva el museo en el popular juego de Animal Crossing.', 400, 3),
	(36, 'Peluche Tommy AC', 'Peluche del personaje que lleva la tienda del pueblo en Animal Crossing', 400, 3),
	(37, 'Peluche Canela AC', 'Peluche de la popular recepcionista del videjuego Animal Crossing.', 400, 3),
